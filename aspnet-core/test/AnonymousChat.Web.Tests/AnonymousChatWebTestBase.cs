...
using AnonymousChat.Models.TokenAuth;
...
{
    public abstract class AnonymousChatWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AnonymousChatWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AnonymousChatWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AnonymousChatDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AnonymousChatDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AnonymousChatDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AnonymousChatDbContext, Task<T>> func)
        {
            T result;
